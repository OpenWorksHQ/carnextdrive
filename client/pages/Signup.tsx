...
async function uploadFilesToServer(
  ...
  async function uploadOne(
    ...
    const url = field === "license" ? body?.licenseUrl : body?.idUrl;
    if (!url) {
      throw new Error(`${field === "license" ? "License" : "ID"} upload URL is missing.`);
    }
    return url;
  }

  return {
    licenseUrl: await uploadOne("license", licenseFile),
    idUrl: await uploadOne("id", idFile),
  };
}
